...
export CONTAINER_TARGET_OUT="${CONTAINER_TARGET_OUT:-/tmp/work/out/${TARGET_OS}_${TARGET_ARCH}}"
export CONTAINER_TARGET_OUT_LINUX="${CONTAINER_TARGET_OUT_LINUX:-/tmp/work/out/linux_amd64}"
